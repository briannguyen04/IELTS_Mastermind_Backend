...
@Entity
@Table(
        name = "learner_question_type_analytics",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_snapshot_question_type",
                        columnNames = {
...
public class LearnerQuestionTypeAnalytics {

    @Id
    @Column(name = "learner_question_type_analytics_id", nullable = false, updatable = false)

...
@Entity
@Table(
        name = "learner_question_type_trend",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_trend_snapshot_question_type",
                        columnNames = {
...
public class LearnerQuestionTypeTrend {

    @Id
    @Column(name = "learner_question_type_trend_id", nullable = false, updatable = false)
